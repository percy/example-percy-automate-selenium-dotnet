...
namespace PercyOnAutomate
{
    ...
    public void Init()
    {
        ...
        public void SearchBstackDemo()
        {
            ...
            string productOnPageText = driver.FindElement(By.XPath("(//p[@class=\"shelf-item__title\"])[2]")).Text;

            // clicking on 'Add to cart' button
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.XPath("(//div[@class=\"shelf-item__buy-btn\"])[2]"))).Click();
